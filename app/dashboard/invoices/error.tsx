'use client'; //! "use client" - error.tsx needs to be a Client Component.
...
//* reset: This is a function to reset the error boundary. When executed, the function 
//! reset will try to re-render the route segment. en este caso va a ser el /dashboard/invoices
...
//! Another way 
//* you can handle errors gracefully is by using the notFound function. While error.tsx is useful for catching all errors, notFound can be used when you try to fetch a resource that doesn't exist.
