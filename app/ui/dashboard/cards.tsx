...
export default async function CardWrapper() {
  ...
  } = await fetchCardData(); // Refresh the page, and you should see all the cards load in at the same time. You can use this pattern when you want multiple components to load in at the same time.
  return (
    <>
